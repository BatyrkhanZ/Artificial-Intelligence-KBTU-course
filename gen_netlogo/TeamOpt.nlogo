...
to read-csv
  if dataset = 1
  [
    set dataR csv:from-file "/dataset/RM1.csv"
    set dataS csv:from-file "/dataset/SM1.csv"
  ]
    if dataset = 2
  [
    set dataR csv:from-file "/dataset/RM2.csv"
    set dataS csv:from-file "/dataset/SM2.csv"
  ]
      if dataset = 3
  [
    set dataR csv:from-file "/dataset/RM3.csv"
    set dataS csv:from-file "/dataset/SM3.csv"
  ]
      if dataset = 4
  [
    set dataR csv:from-file "/dataset/RM4.csv"
    set dataS csv:from-file "/dataset/SM4.csv"
  ]
      if dataset = 5
  [
    set dataR csv:from-file "/dataset/RM5.csv"
    set dataS csv:from-file "/dataset/SM5.csv"
  ]
      if dataset = 6
  [
    set dataR csv:from-file "/dataset/RM6.csv"
    set dataS csv:from-file "/dataset/SM6.csv"
  ]
      if dataset = 7
  [
    set dataR csv:from-file "/dataset/RM7.csv"
